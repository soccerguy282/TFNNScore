...
def fit_model():
    ...
    net.add(layers.Dense(units=40, activation='relu', input_shape=p[0].shape))
    net.add(layers.Dropout(0.4))
    net.add(layers.Dense(units=30, activation='relu'))
    net.add(layers.Dropout(0.3))
    net.add(layers.Dense(units=20, activation='relu'))
    net.add(layers.Dropout(0.2))
    net.add(layers.Dense(units=15, activation='relu'))
    net.add(layers.Dropout(0.1))
    net.add(layers.Dense(units=10, activation='relu'))
    net.add(layers.Dropout(0.1))
